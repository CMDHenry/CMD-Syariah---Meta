...
function excel_content(){
	global $fk_sbg,$nm_customer,$sisa_pokok,$tgl_cair,$bunga_berjalan,$tgl_jatuh_tempo_akhir,$denda,$titipan_angsuran,$pinalti,$fk_cif,$tgl;
