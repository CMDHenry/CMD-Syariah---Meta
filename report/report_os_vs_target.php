...
function filter_request(){
	global $tgl,$showTgl,$showCab,$showWil;
		...
		left join (
			...
			from ( 
				select count(fk_cabang) as jumlah_".$temp.",sum(booking_".$temp.") as booking_".$temp.", tblinventory.fk_cabang as fk_cabang_".$temp." from (
					select sum(pokok_jt)as  booking_".$temp.",fk_sbg as no_sbg from data_fa.tblangsuran
			...
			left join (			
				select fk_cabang as fk_cabang_target_".$temp.",target_os as target_".$temp." from tbltarget 
