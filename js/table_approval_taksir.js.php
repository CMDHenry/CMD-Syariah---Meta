...
//                var harga =  parseFloat( lRow.cells[3].innerHTML.replace(_RegExpEraseNumFormat,"").replace(",",".")) * parseFloat(lRow.cells[5].innerHTML.replace(_RegExpEraseNumFormat,"").replace(",",".")) * document.form1.harga_alhouw.value / 24
//              	lValue=harga;  
