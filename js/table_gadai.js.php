...
//				lCell.appendChild(lObj)
    ...
    function grandTotal(pObj,pParam){
        ...
        //confirm(total)
        pembulatan=Math.round(total).toString().substr(-3,3)
        total=total-pembulatan			
        document.getElementById("divtotal_nilai_pinjaman").innerHTML=number_format(total,true,flag)
        document.form1.total_nilai_pinjaman.value=total
        document.form1.pembulatan.value=pembulatan
        document.getElementById('divpembulatan').innerHTML=number_format(pembulatan,2)									
        fCalculate()
    }
