...
//			}
    ...
    function grandTotal(pObj,pParam){
        ...
        selisih=document.form1.total.value-document.form1.total_detail.value        
 		if(parseFloat(selisih) < 0)flag = true
        else flag = false        
        document.getElementById("divselisih").innerHTML=number_format(selisih,true,flag)
        document.form1.selisih.value=selisih
