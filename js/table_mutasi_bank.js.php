            ...
            switch (pColumn.type) {
                ...
                case "get":
                    ...
                    lObjImg.align="absmiddle"
                 	lObjImg.setAttribute("onclick", "fGetNC(false, '"+pColumn.source+"', 'jenis_mutasi='+escape(document.form1.jenis_mutasi.value)+'&fk_bank_masuk='+escape(document.form1.fk_bank_masuk.value)+'&fk_bank_keluar='+escape(document.form1.fk_bank_keluar.value)+'&kd_"+pColumn.source+"' ,'', _fTableGetInput(this), _fTableGetNext(this),'','','','"+pColumn.id_detail_field+"','mutasi_bank_ho_ke_cabang');")                                        
