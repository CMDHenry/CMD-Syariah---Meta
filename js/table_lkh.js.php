...
?>
	...
	function _fTableGetInput(pObj){
		...
		for (lChild in lObjCell.childNodes){
			...
			if (lObjCell.childNodes[lChild].tagName=="INPUT" || lObjCell.childNodes[lChild].tagName=="SELECT"|| lObjCellNext.childNodes[lChild].type!="hidden") {
...
//                }
//			}
//confirm(pRow.cells[lIndex].errorAjax)
    ...
    function fIsi(){
    	if(document.form1.strisi_detail.value==''){
            var defaultDetail=''
            defaultDetail+="Kertas"+"»"+"100000"+"»"+"0"+"¿";
            defaultDetail+="Kertas"+"»"+"50000"+"»"+"0"+"¿";
            defaultDetail+="Kertas"+"»"+"20000"+"»"+"0"+"¿";
            defaultDetail+="Kertas"+"»"+"10000"+"»"+"0"+"¿";  
            defaultDetail+="Kertas"+"»"+"5000"+"»"+"0"+"¿";  
            defaultDetail+="Kertas"+"»"+"2000"+"»"+"0"+"¿";  
            defaultDetail+="Logam"+"»"+"1000"+"»"+"0"+"¿"; 
            defaultDetail+="Logam"+"»"+"500"+"»"+"0"+"¿";
            defaultDetail+="Logam"+"»"+"200"+"»"+"0"+"¿";  
            defaultDetail+="Logam"+"»"+"100"+"»"+"0"+"¿";
            table_detail.setIsi(defaultDetail);
        }
