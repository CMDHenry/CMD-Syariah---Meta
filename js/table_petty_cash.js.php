...
//			}
    ...
    function grandTotal(pObj,pParam){
       ...
       // sisa_saldo = document.form1.saldo_bank_real.value - document.form1.total.value
       // if(parseFloat(sisa_saldo) < 0)flag = true
       // else flag = false
      //  document.getElementById("divsisa_saldo_real").innerHTML=number_format(sisa_saldo,true,flag)
      //  document.form1.sisa_saldo_real.value=sisa_saldo
