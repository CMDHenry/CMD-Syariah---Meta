...
<input type="hidden" name="tipe" value="Blokir">

<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
	<tr>
		<td class="border">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#D0E4FF">
				<tr><td class="judul_menu" align="center">APPROVAL BUKA BLOKIR</td></tr>
			</table>
		</td>
	</tr>
    <tr>
...
function save_data(){
	...
	if(!pg_query("insert into data_fa.tblapproval_buka_blokir(fk_sbg,tgl_buka) values ('".$fk_sbg."','".date("m/d/Y H:i:s")."')"))$l_success=0;
	$lwhere="fk_sbg='".$fk_sbg."'";
	if(!pg_query(insert_log("data_fa.tblapproval_buka_blokir",$lwhere,'IA')))$l_success=0;
