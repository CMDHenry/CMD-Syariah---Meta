<?php
require_once 'requires/func.inc.php';
require_once 'requires/mime.inc.php';
...
//25 awalny, diganti ke 22 soalnya buat dimeta
	function relay($raddr, $ruser = false, $rpass = false, $rport = 2525, $rauth = 'autodetect', $rvssl = false){
	...
	function attachfile($file, $name = false, $mimetype = 'autodetect', $disposition = 'attachment', $encoding = 'base64', $withOutCheck = false){

		$ret = false;
		//echo "asdsad ".$disposition;
		if(!$withOutCheck){
			if(is_string($file)){
		...
		}else $ret = $this->attachsource(file_get_contents($file), $name, $mimetype, $disposition, $encoding);
		return $ret;
	...
	function _sendtohost($hname, $arrto, $isrelay){//echo '<br>'.$hname.'='.$arrto.'='.$isrelay.'<br>';
