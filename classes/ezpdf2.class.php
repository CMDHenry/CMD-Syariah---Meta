	...
	global $path_site;
        if (!is_array($paper)){ //2 width, 3 height
            switch (strtoupper($paper)){
				...
				case 'STIKER_PART': {$size = array(0,0,400.63,249.45); break;}
				case 'F4': {$size = array(0,0,595.28,935.43); break;}
				case 'BPKB_DETAIL': {$size = array(0,0,793.70,604.70); break;}
		...
		//$this->selectFont('./fonts/Times-Roman'); //setting jenis font di sini //kunci dg font yg paling ok
