	...
	<tr>
		<td class="border">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#D0E4FF">
            	<tr><td class="judul_menu" align="center">DETAIL</td></tr>
			</table>
		</td>
	</tr>
    <tr>
...
?>
    <table cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr style="padding:0 5 0 5" height="20" bgcolor='#C8C8C8' class="judul">
        	<td align="center" width="25%">No Kontrak </td>
...
?>
         <tr style="padding:0 5 0 5" height="20" bgcolor='#efefef'>
			...
			<td style="padding:0 5 0 5" class="" align="center"><?=$lrow["transaksi"]?></td>
			<td style="padding:0 5 0 5" class="" align="right"><?=convert_money("",$lrow["nilai_bayar"],0)?></td>	
         </tr>
